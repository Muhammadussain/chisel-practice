...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/BabyKyberTop_Test/BabyKyberTop.vcd";
    ...
    Verilated::mkdir("test_run_dir/BabyKyberTop_Test/logs");
    VerilatedCov::write("test_run_dir/BabyKyberTop_Test/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
