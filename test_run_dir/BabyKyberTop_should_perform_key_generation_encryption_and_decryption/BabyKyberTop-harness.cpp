...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/BabyKyberTop_should_perform_key_generation_encryption_and_decryption/BabyKyberTop.vcd";
    ...
    Verilated::mkdir("test_run_dir/BabyKyberTop_should_perform_key_generation_encryption_and_decryption/logs");
    VerilatedCov::write("test_run_dir/BabyKyberTop_should_perform_key_generation_encryption_and_decryption/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
