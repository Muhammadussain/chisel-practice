...
int main(int argc, char **argv, char **env) {
    ...
    std::string vcdfile = "test_run_dir/BabyKyberHarness_should_perform_key_generation_encryption_and_decryption_with_detailed_logging_through_Wishbone/BabyKyberHarness.vcd";
    ...
    Verilated::mkdir("test_run_dir/BabyKyberHarness_should_perform_key_generation_encryption_and_decryption_with_detailed_logging_through_Wishbone/logs");
    VerilatedCov::write("test_run_dir/BabyKyberHarness_should_perform_key_generation_encryption_and_decryption_with_detailed_logging_through_Wishbone/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
