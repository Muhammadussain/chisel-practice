...
VL_INLINE_OPT void VBabyKyberHarness___024root___combo__TOP__1(VBabyKyberHarness___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VBabyKyberHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBabyKyberHarness___024root___combo__TOP__1\n"); );
    // Body
...
void VBabyKyberHarness___024root___eval(VBabyKyberHarness___024root* vlSelf) {
    ...
    VBabyKyberHarness___024root___combo__TOP__1(vlSelf);
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
